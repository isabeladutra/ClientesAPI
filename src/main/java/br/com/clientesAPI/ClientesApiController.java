...
public class ClientesApiController {
	...
	@Operation(summary = "Atualiza Dados de um Cliente", responses = {
	 ...
	 @PutMapping("/cliente/{clienteId}")
	    public ResponseEntity<ClienteDTO> atualizarCliente(@PathVariable Long clienteId, @RequestBody ClienteRequest request) {
	        ...
	        Cliente clienteAtualizado = clienteService.atualizarCliente(clienteId, novoCpf, novoNome, novosEmails, novosCelulares);
